...
fn is_supported_op(name: &str) -> bool {
    const SUPPORTED_OPS: &[&str] = &[
        "Add", "Sub", "Mul", "Div", "Relu", "Sigmoid", "Softmax", "Tanh",
        "Conv", "Conv1d", "Conv2d", "Conv3d",
        "MaxPool", "MaxPool1d", "MaxPool2d",
        "MatMul", "Gemm", "Linear", "Flatten", "Reshape", "Shape",
        "Constant", "BatchNormalization", "GlobalAveragePool",
        "Concat", "Transpose", "Squeeze", "Unsqueeze", "Clip", "Cast",
    ];
